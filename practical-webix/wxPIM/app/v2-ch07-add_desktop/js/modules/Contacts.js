...
wxPIM.registeredModules.push("Contacts");
...
wxPIM.moduleClasses.Contacts = class {
  ...
  getUIConfig() {
    ...
    return {
      winWidth : 800, winHeight : 800, winLabel : "Contacts", winIcon : "address-card",
          ...
          rows : [
            function() {
              if (wxPIM.uiType === "mobile") {
                return { view : "unitlist", id : "moduleContacts-items",
                  type : { height : 40 }, template : "#lastName#, #firstName#",
                  uniteBy : (inObj) => {
                    return inObj.lastName.substr(0, 1);
                  },
                  click : wxPIM.modules.Contacts.editExisting.bind(this)
                };
              } else {
                return { view : "datatable", id : "moduleContacts-items",
                  resizeColumn : true, dragColumn : true,
                  columns : [
                    { id : "firstName", header : "First Name", minWidth : 100,
                      sort : "string", adjust : true
                    },
                    { id : "lastName", header : "Last Name", minWidth : 100,
                      sort : "string", adjust : true
                    },
                    { id : "birthday", header : "Birthday", minWidth : 100,
                      sort : "date", adjust : true,
                      format : function(inValue) {
                        return new Date(inValue).toLocaleDateString();
                      }
                    },
                    { id : "homePhone", header : "Home Phone", minWidth : 120,
                      sort : "string", adjust : true
                    },
                    { id : "officePhone", header : "Office Phone",  minWidth : 120,
                      sort : "string", adjust : true, fillspace : true
                    }
                  ],
                  on : { onItemClick : wxPIM.modules.Contacts.editExisting }
                };
              }
            }(),
  ...
  newHandler() {
    ...
    wxPIM.modules.Contacts.isEditingExisting = false;
    wxPIM.modules.Contacts.editingID = new Date().getTime();
  ...
  editExisting(inID) {
    ...
    wxPIM.modules.Contacts.isEditingExisting = true;
    wxPIM.modules.Contacts.editingID = inID;
